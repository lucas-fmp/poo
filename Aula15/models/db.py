...
class Database:
    # ou para pymysql: mysql+pymysql://<usuario>:<senha>@<host>:<porta>/<nome_do_banco>?charset=utf8mb4
    USER = 'root'
    PASSWORD = 'ceub123456'
    HOST = 'localhost'
    PORT = 3306
    ...
    DB_URL = f"mysql+mysqlconnector://{USER}:{PASSWORD}@{HOST}:{PORT}/{DATABASE}?charset=utf8mb4"
